...
```
## Demo
Our demo has been heavily customized to use **YOLOv8-pose** combined with **ByteTrack** for lightning-fast and robust 2D human pose extraction & tracking.
You do NOT need to download HRNet or YOLOv3 weights manually anymore.
First, download our 3D base model checkpoint from [here](https://drive.google.com/file/d/1Iii5EwsFFm9_9lKBUPfN8bV5LmfkNUMP/view) and put it in the `./checkpoint` directory. Then, put your in-the-wild videos in the `./demo/video` directory.
